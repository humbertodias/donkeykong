 ...
 * DonkeyKong
 * StaticObj.h
 * Abstract class that is inherited by Platform and Ladder classes.  Is meant
 * for objects in game that are unchanging on the screen, but are interacted
 * with-- ie. mario and entities can collide with them.
 */
