    ...
    switch (state) {
        case MARIO_WALKING:
            ...
            if (status == MARIO_RIGHT) {  // Moving to the right. Loop walking right animation.
                CSurface::OnDraw(Surf_Display, Surf_Entity, x, y, clipsRight[frame].x, clipsRight[frame].y, MARIO_WIDTH,
                                 MARIO_HEIGHT);
            } else {  // Moving to the left. Loop walking left animation.
                CSurface::OnDraw(Surf_Display, Surf_Entity, x, y, clipsLeft[frame].x, clipsLeft[frame].y, MARIO_WIDTH,
                                 MARIO_HEIGHT);
            }
            break;
        ...
        case MARIO_CLIMBING:
            ...
            CSurface::OnDraw(Surf_Display, Surf_Entity, x, y, clipsUp[frame].x, clipsUp[frame].y, MARIO_WIDTH,
                             MARIO_HEIGHT);
            break;
        ...
        case MARIO_HURTING:
            ...
            if (status == MARIO_RIGHT) {
                CSurface::OnDraw(Surf_Display, Surf_Entity, x, y, clipsHurtR[frame].x, clipsHurtR[frame].y, MARIO_WIDTH,
                                 MARIO_HEIGHT);  // Make mario flicker while facing right
            } else if (status == MARIO_LEFT) {
                CSurface::OnDraw(Surf_Display, Surf_Entity, x, y, clipsHurtL[frame].x, clipsHurtL[frame].y, MARIO_WIDTH,
